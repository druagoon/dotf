...
# @describe Install a binary release of dotf hosted on GitHub
...
# Project metadata
readonly NAME="dotf"
readonly URL="https://github.com/druagoon/dotf"
...
_argc_usage() {
    cat <<-'EOF'
Install a binary release of dotf hosted on GitHub
